...
## Architecture & Design
The configuration follows a modular approach for better maintainability and reusability. With time i will add more modules(lxc and SDWAN):
